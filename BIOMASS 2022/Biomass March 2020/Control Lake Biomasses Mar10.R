...
Cntrls.Cmbo.Bio <- Cntrls.Cmbo.Bio[-c(17),]
Cntrls.Cmbo.Bio <- Cntrls.Cmbo.Bio[-c(31),]
Cntrls.Cmbo.Bio


############ Visualize Plot ##################

Cntrls.Bio20.Fig <- ggplot(Cntrls.Cmbo.Bio,
                           aes(x = Year,
                               y = Mean.total)
                           ) +
  theme_bw()+
  ...
  scale_y_continuous(breaks = c(-200,
                                -100,
                                0,
                                100,
                                200,
